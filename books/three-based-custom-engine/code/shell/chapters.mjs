...
export const CHAPTERS = [
  ...
  },
  {
    id: '03-scene-graph',
    number: 3,
    title: 'Граф сцены и преобразования',
    demo: 'Иерархия узлов, грязный флаг, цепочка пространств до пикселей',
  },
  {
    id: '04-world-model',
    number: 4,
    title: 'Модель мира: сущности и компоненты',
    demo: 'Сущность-число, плотные хранилища, системы по фазам, очередь событий',
  },
];
